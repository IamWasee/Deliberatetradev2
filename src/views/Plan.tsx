  ...
  return (
    <div className="h-full overflow-y-auto p-3 md:p-4">
      <div className="max-w-[860px] mx-auto space-y-3.5">
        <div className="panel p-5 animate-fade-up" style={{ borderLeft: "3px solid #39c5a5" }}>
          <div className="flex flex-wrap items-center gap-3 mb-4">
            <h2 className="font-display font-bold text-[20px] text-fog-100">Trading contract</h2>
            <span className="lbl px-2 py-1 rounded-full text-teal" style={{ fontSize: 9.5, border: "1px solid rgba(57,197,165,0.4)" }}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
            {[
              ...
              ["Max positions", String(plan.maxPositions)],
              ["Friction", s.friction],
            ].map(([k, v]) => (
          ...
          <div className="grid md:grid-cols-2 gap-2.5 mt-2.5">
            <div className="panel-inset p-3">
              <p className="lbl mb-1.5" style={{ fontSize: 8.5 }}>Forbidden actions</p>
            ...
            <div className="panel-inset p-3">
              <p className="lbl mb-1.5" style={{ fontSize: 8.5 }}>Declared setups</p>
          ...
          {plan.note && (
            <div className="panel-inset p-3 mt-2.5">
              <p className="lbl mb-1" style={{ fontSize: 8.5 }}>Intentions</p>
        ...
        <div className="panel p-4 animate-fade-up" style={{ animationDelay: "80ms" }}>
          ...
          {s.planHistory.map((h) => (
            <div key={h.version} className="flex items-start gap-3 py-2.5 border-b last:border-0" style={{ borderColor: "#16213a" }}>
