...
const WALKTHROUGH: Step[] = [
  ...
  { id: "chart", target: '[data-tour="chart"]', view: "terminal", title: "The chart", body: "Green candle = buyers won that window; red = sellers. Drag to pan history, wheel to zoom, double-click for live. The Indicators button adds SMA/EMA/RSI/MACD/Bollinger/VWAP/ATR — computed from these exact candles. Your ENTRY, STOP and TARGET lines draw right on it. The REGIME chip says trend, range or chop — trade the regime you're in." },
